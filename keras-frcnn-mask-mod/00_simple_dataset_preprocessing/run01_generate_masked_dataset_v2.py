...
#################################################
def generateRandomizedScene(pathBG, pathIdxFG, p_rangeSizes=(64, 256), p_rangeAngle=(0, 36), p_rangeNumSamples=(3, 16), isDebug=False):
...
if __name__ == '__main__':
    ...
    wdirOut = '/home/ar/prj_datamola/frcnn_test_dataset_1/generated_data'
    if not os.path.isdir(wdirOut):
        os.makedirs(wdirOut)
    #
    isDebug = False
    def_range_sizes=(96, 384)
    def_range_angle=(0,  24)
    def_range_num_samples = (3, 8)
    def_cls_names = {
        1: 'bear',
        2: 'cat',
        3: 'dog',
    ...
    for ipathBG, pathBG in enumerate(pathImgsBG):
        ...
        imgCnt += 1
        print ('\t[{0}/{1}] : {2}'.format(ipathBG, numImgsBG, pathBG))