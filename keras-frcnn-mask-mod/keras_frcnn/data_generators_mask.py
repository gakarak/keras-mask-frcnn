...
def get_anchor_gt_mask(all_img_data, class_count, C, backend, mode='train'):
    ...
    while True:
        ...
        for img_data in all_img_data:
            try:
                ...
                if mode == 'train':
                    img_data_aug, x_img, x_msk_i, x_msk_s = data_augment_mask.augment_mask(img_data, C, augment=True)
                else:
                    img_data_aug, x_img, x_msk_i, x_msk_s = data_augment_mask.augment_mask(img_data, C, augment=False)
